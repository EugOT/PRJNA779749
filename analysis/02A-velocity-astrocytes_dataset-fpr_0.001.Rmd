...
docname <- "02A-velocity-astrocytes_dataset-fpr_0.001"
now <- Sys.time()
...
adata$var <-
  ...
  left_join(y = genes_update,
            by = join_by(ENSMBL_id == input),
            multiple = "any") %>%
  left_join(y = rownames_to_column(subregion_srt@assays$RNA@meta.features,
                                   var = "name"),
            by = "name") %>% 
  mutate(selected = str_detect(pattern = var_regex,
                               string = name,
                               negate = TRUE)) %>%
  r_to_py()
...
scv$pl$velocity_embedding_stream(
  a.plot.vv,
  basis = 'veloviz1',
  color = c('Ndrg2', 'Gfap',  'Apoe', 'Gja1', 'Slc1a3', "Aldoc", "Aldh1l1", "Adcyap1r1", "Htra1", "Ntsr2", "Lxn", "Egfr", "Cst3", "Fgfr3", "Slit2", "Mfn2", "Dagla", "Daglb", "Mgll"),
  legend_loc='none',
  alpha=.6, legend_fontsize=12, arrow_color='darkslategrey',
...
```
```{r}
cr$tl$terminal_states(a.plot.vv, cluster_key = "clusters", weight_connectivities = 0.2, softmax_scale=4, method = 'brandts')
cr$tl$initial_states(a.plot.vv, cluster_key = "clusters", method = 'brandts')
...
```{r}
scv$pl$velocity(adata, c('Ndrg2', 'Gfap',  'Apoe', 'Gja1', 'Slc1a3', "Aldoc", "Aldh1l1", "Adcyap1r1", "Htra1", "Ntsr2", "Lxn", "Egfr", "Cst3", "Fgfr3", "Slit2", "Mfn2", "Dagla", "Daglb", "Mgll"), show = TRUE, ncols = 2)
```
...
cr$pl$circular_projection(
    a.plot.vv,
    keys=c("latent_time", "kl_divergence", 'Ndrg2', 'Gfap',  'Apoe', 'Gja1', 'Slc1a3', "Aldoc", "Aldh1l1", "Adcyap1r1", "Htra1", "Ntsr2", "Lxn", "Egfr", "Cst3", "Fgfr3", "Slit2", "Mfn2", "Dagla", "Daglb", "Mgll"),
